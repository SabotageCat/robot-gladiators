var fightOrSkip = function() {
  ...
  //conditional recursive call function
...
var fight = function(enemy) {
  ...
  while (playerInfo.health > 0 && enemy.health > 0) {
      if(isPlayerTurn) {
        //ask player if they'd like to fightor skip usinf fightOrSkip function
        if (fightOrSkip()) {
      ...
      //remove enemy health by subracting amount set in damage
...
var endGame = function() {
  ...
  if (playerInfo.money > highScore) {
    ...
    alert(playerInfo.name + " did not beat the highscore of " + highScore + ". Naybe next time!");
  }
